...
export default function Home() {
  ...
  const faqs = [
    {
      question: "What exactly does the GEO Audit analyze?",
      answer: "We check 6 key areas: content structure (headings, word count), schema markup, citability (how quotable your content is), authority signals, freshness indicators, and technical accessibility. You get a GEO Score out of 100."
    },
    {
    ...
    },
    {
      ...
      answer: "Yes. You get 3 GEO Audits and 5 schema generations per month, forever free. No credit card required. Upgrade only when you need unlimited access."
    }
  ]
