...
export default function Home() {
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="border-y border-dream-ink/5 bg-white/60 backdrop-blur-md py-12 overflow-hidden relative z-20">
        <div className="max-w-6xl mx-auto px-4">
          <p className="text-center text-sm font-bold text-dream-ink-muted uppercase tracking-widest mb-8">
            Optimized for all major AI engines
          </p>
          <div className="flex justify-center items-center gap-12 md:gap-24 lg:gap-32 w-full">
      ...
      <section className="py-24 bg-white/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative h-[450px] bg-dream-ink rounded-3xl p-8 text-white shadow-2xl transform rotate-1 hover:rotate-0 transition-transform duration-500 animate-enter delay-200">
      ...
      {/* Tools Bento Grid */}
      <section className="py-24 px-4 relative z-10 bg-gradient-to-b from-white/0 to-white/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-dream-purple-600 font-bold tracking-widest uppercase text-sm mb-4 block">Our Tools</span>
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-dream-ink">The GEO Toolkit</h2>
            <p className="text-xl text-dream-ink-light max-w-2xl mx-auto">
              Everything you need to measure, improve, and monitor your brand's presence in AI.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-12 gap-6">
              ...
              <Link href="/tools/ai-visibility" className="block h-full glass-card rounded-[2rem] relative overflow-hidden group animate-enter delay-200">
                <div className="p-10 h-full flex flex-col relative z-10">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <span className="px-4 py-2 rounded-full bg-dream-ink text-white text-xs font-bold uppercase tracking-wider">Free</span>
                  </div>
                  ...
                  <p className="text-lg text-dream-ink-light max-w-md mb-8">
                    See how ChatGPT, Claude, and Gemini really see your brand. 
            ...
            <div className="md:col-span-8 h-[260px]">
  ...
  "url": "https://dwight.ai"
      ...
      {/* CTA Section */}
      <section className="py-24 px-4 text-center relative bg-gradient-to-b from-transparent to-dream-purple-50/50">
         <div className="max-w-3xl mx-auto">
           <h2 className="text-4xl md:text-5xl font-bold mb-6 text-dream-ink">
             Ready to be <span className="text-gradient">Recommended?</span>
           </h2>
           <p className="text-lg text-dream-ink-light mb-10 max-w-xl mx-auto">
             Start with our free tools. No credit card required.
           </p>
           <div className="flex flex-col sm:flex-row gap-4 justify-center">
             <Link href="/tools/ai-visibility" className="btn-primary text-base px-8 py-4 shadow-lg shadow-dream-purple-500/20">
               Get Your Free Score
             </Link>
      ...
      {/* Footer */}
      <footer className="py-16 border-t border-dream-ink/5 bg-white">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-center md:text-left">
            <div className="font-display text-xl font-bold text-dream-ink mb-1 flex items-center gap-2 justify-center md:justify-start">
              <div className="relative w-6 h-6">
                <Image src="/logos/miageru-geo.svg" alt="Miageru Logo" fill className="object-contain" />
              </div>
              Miageru
            </div>
            <p className="text-sm text-dream-ink-muted">© 2025 Miageru. All rights reserved.</p>
          </div>
          <div className="flex gap-8 text-sm font-medium text-dream-ink-muted">
            <Link href="/" className="hover:text-dream-ink transition-colors">Home</Link>
            <Link href="/tools" className="hover:text-dream-ink transition-colors">Tools</Link>
            <Link href="/pricing" className="hover:text-dream-ink transition-colors">Pricing</Link>
            <Link href="/contact" className="hover:text-dream-ink transition-colors">Contact</Link>
          </div>
        </div>
      </footer>
    </div>
