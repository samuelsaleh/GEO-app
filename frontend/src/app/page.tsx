...
import { Search, Code, CheckCircle, ArrowRight, Sparkles } from 'lucide-react'
    ...
    <div className="min-h-screen hero-gradient">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-6">
              <Link href="#services" className="text-ink-600 hover:text-claude-500 transition-colors font-medium">
                Services
              </Link>
      ...
      <section className="pt-24 pb-32 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-ink-500 mb-12 max-w-3xl mx-auto animate-fade-in-up animate-delay-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto animate-fade-in-up animate-delay-400">
            <div className="card-elevated p-8">
              <div className="text-4xl font-display font-bold text-claude-500 mb-2">25%</div>
              <div className="text-ink-500">Predicted drop in traditional search by 2028</div>
            </div>
            <div className="card-elevated p-8">
              <div className="text-4xl font-display font-bold text-claude-500 mb-2">60%</div>
              <div className="text-ink-500">Potential traffic loss from AI-powered search</div>
            </div>
            <div className="card-elevated p-8">
              <div className="text-4xl font-display font-bold text-claude-500 mb-2">100M+</div>
              <div className="text-ink-500">ChatGPT users asking questions daily</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="services" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl font-bold mb-4 text-ink-900">Our Core Services</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="card-elevated p-10">
              <div className="w-14 h-14 bg-claude-100 rounded-xl flex items-center justify-center mb-6">
                <Search className="w-7 h-7 text-claude-500" />
              </div>
              <h3 className="font-display text-2xl font-bold mb-4 text-ink-900">AI Visibility Health-Check</h3>
              ...
              <div className="space-y-3 mb-8">
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-claude-500 mt-0.5 flex-shrink-0" />
                  <span className="text-ink-600">Score sheet with 0-100 AI readiness score</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-claude-500 mt-0.5 flex-shrink-0" />
                  <span className="text-ink-600">Screenshots of AI mentions (or misses)</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-claude-500 mt-0.5 flex-shrink-0" />
                  <span className="text-ink-600">Top 5 fixes with clear action steps</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-claude-500 mt-0.5 flex-shrink-0" />
                  <span className="text-ink-600">15-slide picture report + video walkthrough</span>
                </div>
              </div>

              <div className="flex items-baseline gap-2 mb-6">
                <span className="text-3xl font-display font-bold text-ink-900">€1,700</span>
            ...
            {/* Service 2 */}
            <div className="card-elevated p-10">
              <div className="w-14 h-14 bg-cream-300 rounded-xl flex items-center justify-center mb-6">
                <Code className="w-7 h-7 text-ink-600" />
              </div>
              <h3 className="font-display text-2xl font-bold mb-4 text-ink-900">Schema & Labels Fix-Up</h3>
              <p className="text-ink-500 mb-6 leading-relaxed">
              ...
              <div className="space-y-3 mb-8">
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-ink-400 mt-0.5 flex-shrink-0" />
                  <span className="text-ink-600">Ready-made JSON-LD code snippets</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-ink-400 mt-0.5 flex-shrink-0" />
                  <span className="text-ink-600">Product, FAQ, Article, How-to schemas</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-ink-400 mt-0.5 flex-shrink-0" />
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-ink-400 mt-0.5 flex-shrink-0" />
                  <span className="text-ink-600">Installation guide for your developer</span>
                </div>
              </div>

              <div className="flex items-baseline gap-2 mb-6">
                <span className="text-3xl font-display font-bold text-ink-900">€130</span>
                <span className="text-ink-400">- €260 per page type</span>
              </div>
      ...
      <section className="py-24 bg-cream-200">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="font-display text-4xl font-bold text-center mb-16 text-ink-900">Why This Matters Now</h2>

          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center card-elevated p-10">
              <div className="text-5xl mb-6">🤖</div>
              <h3 className="font-display text-xl font-bold mb-4 text-ink-900">AI Search is Exploding</h3>
            ...
            <div className="text-center card-elevated p-10">
              <div className="text-5xl mb-6">📉</div>
              <h3 className="font-display text-xl font-bold mb-4 text-ink-900">Traffic is Shifting</h3>
              <p className="text-ink-500 leading-relaxed">
            ...
            <div className="text-center card-elevated p-10">
              <div className="text-5xl mb-6">⚡</div>
              <h3 className="font-display text-xl font-bold mb-4 text-ink-900">Act Before Competitors</h3>
              <p className="text-ink-500 leading-relaxed">
      ...
      {/* Waitlist CTA */}
      <section className="py-24 bg-gradient-to-br from-claude-500 to-claude-600">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="font-display text-4xl md:text-5xl font-bold text-white mb-6">
            Get Early Access to Dwight
          </h2>
          <p className="text-xl text-claude-100 mb-10">
          ...
          <form onSubmit={handleWaitlistSubmit} className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto">
            <input
              ...
              className="flex-1 px-6 py-4 rounded-lg text-ink-900 border-0 shadow-lg"
              required
            />
            <button
              type="submit"
              disabled={loading}
              className="bg-ink-900 text-white px-8 py-4 rounded-lg hover:bg-ink-800 transition font-semibold whitespace-nowrap shadow-lg disabled:opacity-70"
            >
          ...
          {submitted && (
            <div className="mt-6 bg-white/20 backdrop-blur-sm text-white px-6 py-3 rounded-lg inline-flex items-center gap-2 shadow">
      ...
      <footer className="bg-ink-950 text-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-12">
            ...
            <div>
              <h4 className="font-semibold mb-4 text-claude-400">Services</h4>
