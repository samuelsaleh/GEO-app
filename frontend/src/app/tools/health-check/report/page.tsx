...
const templateData = {
  company: {
    ...
    preparedBy: "Miageru AI Visibility Team"
  },
  scores: {
        ...
        <div className="bg-white shadow-lg print:shadow-none">
          ...
          <div className="p-12 border-b-4 border-claude-500 print:break-after-page">
            ...
            <div className="mt-16 text-center text-gray-400 text-sm">
              Powered by Miageru • AI Search Visibility Platform
            </div>
          </div>
          ...
          <div className="p-8 border-t text-center text-gray-400 text-sm">
            <p>This report was generated by Miageru AI Visibility Platform</p>
            <p className="mt-1">© {new Date().getFullYear()} Miageru • miageru.app</p>
          </div>
